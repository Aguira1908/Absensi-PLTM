    ...
    <div className="min-h-screen bg-gray-100">
      ...
      {flashMessage && (
        <div className="fixed top-4 right-4 z-50 animate-fade-in-down">
          <div
            className={`px-6 py-4 rounded-xl shadow-xl font-medium text-white flex items-center gap-3 transition-all duration-300 ${
          ...
          >
            ...
            <button
              ...
              className="ml-2 hover:opacity-75 shrink-0"
            >
              <svg
                className="w-4 h-4"
                fill="none"
